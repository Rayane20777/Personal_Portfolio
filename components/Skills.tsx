          ...
          <AnimatePresence>
            {filteredSkills.map(skill => (
                <motion.div
                    ...
                    className="bg-gray-800 rounded-lg p-3 shadow-lg hover:shadow-emerald-400/10 transition-shadow duration-300"
                >
                  <h4 className="text-base font-semibold text-emerald-400 mb-2">{skill.name}</h4>
